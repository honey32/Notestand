...
export async function renderPdfPageAsSVG(page: PdfPage, option: ViewportOptions = { scale: 1, rotation: 0 }): Promise<SVGElement> {
...
export async function forEachPages<R>(document: Document, fn: (page: PdfPage, idx?: number) => Promise<R>) {
